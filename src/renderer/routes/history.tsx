  ...
  return (
    <section className="flex h-full flex-col overflow-hidden p-8">
      <header className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-[#e8eaed]">History</h1>
          <p className="mt-1 text-sm text-[#9aa0a6]">Recently translated pages.</p>
        </div>
      ...
      <div className="glass min-h-0 flex-1 overflow-auto rounded-xl">
        {!history.data?.length ? (
          <div className="flex h-full items-center justify-center text-center">
            <div>
              <Clock3 className="mx-auto text-[#9aa0a6]" size={28} />
              <div className="mt-3 text-sm text-[#bdc1c6]">No translated pages yet.</div>
            </div>
          </div>
        ) : (
